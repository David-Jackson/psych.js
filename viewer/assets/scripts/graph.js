function Graph(_width, _height) {
	...
	this.addLine = function(style, points) {
		console.log("Adding line with", points.length, "points");
		points.forEach(pt => {
			if (typeof pt.properties.graphX == "undefined") this.calculatePosition(pt)
		});
		this.lines.push({style: style, points: points});
	}
	...
	this.addShape = function(style, points) {
		...
		this.shapes.push({style: style, points: points});
	}
	...
	this.drawLines = function() {
		...
		this.lines.forEach(function(line) {
			console.log("Drawing line with", line.points.length, "points");
